...
float leftMinimum = 10;         // minimum value of the left flex sensor
float rightMinimum = 10;        // minimum value of the right flex sensor
float leftMaximum = 40;         // maximum value of the left flex sensor
float rightMaximum = 40;        // maximum value of the right flex sensor
